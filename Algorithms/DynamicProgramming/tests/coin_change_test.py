...
def test_no_coins():
    coins = []
    amount = 1
    assert coin_change_bottom_up(coins, amount) == -1
...
def test_basic():
    coins = [1]
    amount = 123
    assert coin_change_bottom_up(coins, amount) == 123
    assert coin_change_top_down(coins, amount) == 123

def test_multiple_coins():
    coins = [1, 2, 5, 10, 20, 50, 100]
    amount = 113
    assert coin_change_bottom_up(coins, amount) == 4
    assert coin_change_top_down(coins, amount) == 4
